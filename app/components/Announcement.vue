...
watch(
  ...
  (newVal) => {
    ...
    const changed =
      ...
      newVal.id !== lastAnnouncement.value.id ||
      newVal.type !== lastAnnouncement.value.type ||
      newVal.message !== lastAnnouncement.value.message ||
      newVal.dismissible !== lastAnnouncement.value.dismissible
